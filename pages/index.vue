<template>
  <div class="root">
    <a href="https://github.com/aurowallet/bip39-checker" target="_blank" class="github-corner" aria-label="View source on GitHub">
    ...
    <div class="bi39">
      <div class="helper">
        <input class="words-input"
               ...
               placeholder="Input one BIP39 word">
...
export default {
  ...
  head() {
    return {
      ...
      title: 'BIP39 WORD HELPER',
      meta: [
        {
          name: 'description', content: 'Help you find the right mnemonics'
        },
        {
          name: 'keywords', content: 'BIP39'
        }
      ],
      script: [
      ]
    ...
    matchedWords: function () {
      if (!this.word) {
        ...
        return words.filter((item)=>{
          return item.indexOf(this.word) === 0;
        });
      }
    }
  }
